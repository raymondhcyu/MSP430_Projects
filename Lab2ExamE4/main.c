...
unsigned int flashFreq = 25000;
// Dim to bright
void flashIt(void) {
    while (1) {
        TB1CCR0 = 50000 - 1; // = (CLK/divider)/target = (8E6/32)/5; subtract one since it counts more
        TB1CCR1 = flashFreq; // change this

        __delay_cycles(100000);

        flashFreq = flashFreq - 500;
        if (flashFreq == 0) {
            flashFreq = 25000;
        }
    }
